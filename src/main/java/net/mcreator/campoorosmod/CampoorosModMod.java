 ...
 *
 */
package net.mcreator.campoorosmod;
...
@Mod("campooros_mod")
public class CampoorosModMod {
	public static final Logger LOGGER = LogManager.getLogger(CampoorosModMod.class);
	public static final String MODID = "campooros_mod";
